let studyIds =
    '8yadFPpU BJy6fEDf Rg2cMBZ6 fE4k21MW 8yadFPpU PDkQDt6u 96Lij7wH 9ogFv8Ac xebrDvFe A4ujYOer'
        .split(' ');
...
function makePly(fen) { return fen.split(' ')[1] === 'w' ? 0 : 1; }

let chapters = db.study_chapter
                   .find({
                     studyId : {
                       $in : studyIds,
                     },
                   ...
                   .forEach(function(chapter) {
                     let fen = chapter.root.f;
                     let fixed = fixFen(fen);
                     if (fixed != fen) {
