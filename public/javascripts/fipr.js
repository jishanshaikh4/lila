...
window.fipr = (function() {
  ...
  var l =
    ...
    let n = [ 0, 0, 0, 0 ];
    return ((n[3] += e[3] + t[3]), (n[2] += n[3] >>> 16), (n[3] &= 65535),
            (n[2] += e[2] + t[2]), (n[1] += n[2] >>> 16), (n[2] &= 65535),
            (n[1] += e[1] + t[1]), (n[0] += n[1] >>> 16), (n[1] &= 65535),
            (n[0] += e[0] + t[0]), (n[0] &= 65535),
      ...
      f =
        ...
        let n = [ 0, 0, 0, 0 ];
        return ((n[3] += e[3] * t[3]), (n[2] += n[3] >>> 16), (n[3] &= 65535),
                (n[2] += e[2] * t[3]), (n[1] += n[2] >>> 16), (n[2] &= 65535),
                (n[2] += e[3] * t[2]), (n[1] += n[2] >>> 16), (n[2] &= 65535),
                (n[1] += e[1] * t[3]), (n[0] += n[1] >>> 16), (n[1] &= 65535),
                (n[1] += e[2] * t[2]), (n[0] += n[1] >>> 16), (n[1] &= 65535),
                (n[1] += e[3] * t[1]), (n[0] += n[1] >>> 16), (n[1] &= 65535),
      ...
      a =
        ...
        return null == e ? a
               : Array.prototype.map && e.map === Array.prototype.map
                   ? e.map(r)
                   : (d(e, function(e, t, n) { a.push(r(e, t, n)); }), a);
      },
      n =
          function(e) {
      ...
      i =
        ...
        return (u(e) && (t = t.sort(function(e, t) {
                ...
                a(t, function(e) {
                  let t = a(e, function(e) { return [ e.type, e.suffixes ]; });
      ...
      o =
        ...
        return (
            ...
            navigator.plugins && (e = e.concat(i(n))), e);
      },
      u =
          function(e) {
        for (var t = !1, n = 0, r = e.plugins.sortPluginsFor.length; n < r;
             n++) {
      ...
      w = function(e) { return navigator.cpuClass || e.NOT_AVAILABLE; },
      E =
          function(e) {
      ...
      O =
          function(e) {
        let t = [], n = document.createElement('canvas');
        (n.width = 2e3), (n.height = 200), (n.style.display = 'inline');
        let r = n.getContext('2d');
        return (
            r.rect(0, 0, 10, 10), r.rect(2, 2, 6, 6),
            t.push('canvas winding:' +
                   (!1 === r.isPointInPath(5, 5, 'evenodd') ? 'yes' : 'no')),
            (r.textBaseline = 'alphabetic'), (r.fillStyle = '#f60'),
            r.fillRect(125, 1, 62, 20), (r.fillStyle = '#069'),
            e.dontUseFakeFontInCanvas ? (r.font = '11pt Arial')
                                      : (r.font = '11pt no-real-font-123'),
            r.fillText('Cwm fjordbank glyphs vext quiz, \ud83d\ude03', 2, 15),
            (r.fillStyle = 'rgba(102, 204, 0, 0.2)'), (r.font = '18pt Arial'),
            r.fillText('Cwm fjordbank glyphs vext quiz, \ud83d\ude03', 4, 45),
            (r.globalCompositeOperation = 'multiply'),
            (r.fillStyle = 'rgb(255,0,255)'), r.beginPath(),
            r.arc(50, 50, 50, 0, 2 * Math.PI, !0), r.closePath(), r.fill(),
            (r.fillStyle = 'rgb(0,255,255)'), r.beginPath(),
            r.arc(100, 50, 50, 0, 2 * Math.PI, !0), r.closePath(), r.fill(),
            (r.fillStyle = 'rgb(255,255,0)'), r.beginPath(),
            r.arc(75, 100, 50, 0, 2 * Math.PI, !0), r.closePath(), r.fill(),
            (r.fillStyle = 'rgb(255,0,255)'),
            r.arc(75, 75, 75, 0, 2 * Math.PI, !0),
            r.arc(75, 75, 25, 0, 2 * Math.PI, !0), r.fill('evenodd'),
            n.toDataURL && t.push('canvas fp:' + n.toDataURL()), t);
      },
      y =
          function() {
        var e = function(e) {
          return (o.clearColor(0, 0, 0, 1), o.enable(o.DEPTH_TEST),
        ...
        if (!o)
          return null;
        let c = [], t = o.createBuffer();
        o.bindBuffer(o.ARRAY_BUFFER, t);
        let n = new Float32Array(
            [ -0.2, -0.9, 0, 0.4, -0.26, 0, 0, 0.732134444, 0 ]);
        o.bufferData(o.ARRAY_BUFFER, n, o.STATIC_DRAW), (t.itemSize = 3),
            (t.numItems = 3);
        let r = o.createProgram(), a = o.createShader(o.VERTEX_SHADER);
        o.shaderSource(
            a,
        ...
        o.shaderSource(
            ...
            o.compileShader(i), o.attachShader(r, a), o.attachShader(r, i),
            o.linkProgram(r), o.useProgram(r),
            ...
            o.vertexAttribPointer(r.vertexPosAttrib, t.itemSize, o.FLOAT, !1, 0,
                                  0),
        ...
        c.push('extensions:' + (o.getSupportedExtensions() || []).join(';')),
            ...
            c.push('webgl max anisotropy:' + (function(e) {
                     let t =
            ...
            c.push('webgl max combined texture image units:' +
                   o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS)),
            c.push('webgl max cube map texture size:' +
            ...
            c.push('webgl max texture image units:' +
                   o.getParameter(o.MAX_TEXTURE_IMAGE_UNITS)),
            c.push('webgl max texture size:' +
                   o.getParameter(o.MAX_TEXTURE_SIZE)),
            c.push('webgl max varying vectors:' +
                   o.getParameter(o.MAX_VARYING_VECTORS)),
            c.push('webgl max vertex attribs:' +
                   o.getParameter(o.MAX_VERTEX_ATTRIBS)),
            c.push('webgl max vertex texture image units:' +
        ...
        try {
          ...
          u && (c.push('webgl unmasked vendor:' +
                       o.getParameter(u.UNMASKED_VENDOR_WEBGL)),
                c.push('webgl unmasked renderer:' +
                       o.getParameter(u.UNMASKED_RENDERER_WEBGL)));
        } catch (s) {
        }
        return (
            o.getShaderPrecisionFormat && d([ 'FLOAT', 'INT' ], function(i) {
              d([ 'VERTEX', 'FRAGMENT' ], function(a) {
                d([ 'HIGH', 'MEDIUM', 'LOW' ], function(r) {
                  d([ 'precision', 'rangeMin', 'rangeMax' ], function(e) {
                    let t = o.getShaderPrecisionFormat(o[a + '_SHADER'],
                                                       o[r + '_' + i])[e];
      ...
      S =
          function() {
        try {
          let e = I(), t = e.getExtension('WEBGL_debug_renderer_info'),
              n = e.getParameter(t.UNMASKED_VENDOR_WEBGL) + '~' +
      ...
      _ =
          function() {
        let e = navigator.userAgent.toLowerCase(), t = navigator.oscpu,
            n = navigator.platform.toLowerCase(),
            r = 0 <= e.indexOf('windows phone') ? 'Windows Phone'
                : 0 <= e.indexOf('windows') || 0 <= e.indexOf('win16') ||
                        0 <= e.indexOf('win32') || 0 <= e.indexOf('win64') ||
                        0 <= e.indexOf('win95') || 0 <= e.indexOf('win98') ||
                        0 <= e.indexOf('winnt') || 0 <= e.indexOf('wow64')
                    ? 'Windows'
                : 0 <= e.indexOf('android') ? 'Android'
                : 0 <= e.indexOf('linux') || 0 <= e.indexOf('cros') ||
                        0 <= e.indexOf('x11')
                    ? 'Linux'
                : 0 <= e.indexOf('iphone') || 0 <= e.indexOf('ipad') ||
                        0 <= e.indexOf('ipod') || 0 <= e.indexOf('crios') ||
                        0 <= e.indexOf('fxios')
                    ? 'iOS'
        ...
        if (('ontouchstart' in window || 0 < navigator.maxTouchPoints ||
            ...
            'Windows' !== r && 'Windows Phone' !== r && 'Android' !== r &&
            'iOS' !== r && 'Other' !== r && -1 === e.indexOf('cros'))
          return !0;
        if (void 0 !== t) {
          if (0 <= (t = t.toLowerCase()).indexOf('win') && 'Windows' !== r &&
              'Windows Phone' !== r)
            return !0;
          ...
          if (0 <= t.indexOf('mac') && 'Mac' !== r && 'iOS' !== r)
            return !0;
          if ((-1 === t.indexOf('win') && -1 === t.indexOf('linux') &&
               -1 === t.indexOf('mac')) != ('Other' === r))
            return !0;
        }
        return ((0 <= n.indexOf('win') && 'Windows' !== r &&
                 'Windows Phone' !== r) ||
                ((0 <= n.indexOf('linux') || 0 <= n.indexOf('android') ||
                  0 <= n.indexOf('pike')) &&
                 'Linux' !== r && 'Android' !== r) ||
                ((0 <= n.indexOf('mac') || 0 <= n.indexOf('ipad') ||
                  0 <= n.indexOf('ipod') || 0 <= n.indexOf('iphone')) &&
                 'Mac' !== r && 'iOS' !== r) ||
                (!(0 <= n.indexOf('arm') && 'Windows Phone' === r) &&
                 !(0 <= n.indexOf('pike') && 0 <= e.indexOf('opera mini')) &&
                 ((n.indexOf('win') < 0 && n.indexOf('linux') < 0 &&
                   n.indexOf('mac') < 0 && n.indexOf('iphone') < 0 &&
                   n.indexOf('ipad') < 0 && n.indexOf('ipod') < 0) !=
                      ('Other' === r) ||
                  ('undefined' == typeof navigator.plugins && 'Windows' !== r &&
                   'Windows Phone' !== r))));
      },
      P =
          function() {
        let e, t = navigator.userAgent.toLowerCase(), n = navigator.productSub;
        if (0 <= t.indexOf('edge/') || 0 <= t.indexOf('iemobile/'))
          return !1;
        if (0 <= t.indexOf('opera mini'))
          return !1;
        if (('Chrome' ===
                 (e = 0 <= t.indexOf('firefox/') ? 'Firefox'
                      : 0 <= t.indexOf('opera/') || 0 <= t.indexOf(' opr/')
                          ? 'Opera'
                      : 0 <= t.indexOf('chrome/') ? 'Chrome'
                      : 0 <= t.indexOf('safari/')
                          ? 0 <= t.indexOf('android 1.') ||
                                ...
                                ? 'AOSP'
                                : 'Safari'
                      : 0 <= t.indexOf('trident/') ? 'Internet Explorer'
                                                   : 'Other') ||
             'Safari' === e || 'Opera' === e) &&
            '20030107' !== n)
          return !0;
        let r, a = eval.toString().length;
        if (37 === a && 'Safari' !== e && 'Firefox' !== e && 'Other' !== e)
          return !0;
        if (39 === a && 'Internet Explorer' !== e && 'Other' !== e)
          return !0;
        if (33 === a && 'Chrome' !== e && 'AOSP' !== e && 'Opera' !== e &&
            'Other' !== e)
          return !0;
        try {
          throw 'a';
      ...
      D =
        ...
        if (!R())
          return !1;
        let e = I(), t = !!window.WebGLRenderingContext && !!e;
        return M(e), t;
      },
      L =
          function() {
      ...
      I =
          function() {
        let e = document.createElement('canvas'), t = null;
        try {
      ...
      k =
          [
            {
              key : 'userAgent',
              getData : function(e) { e(navigator.userAgent); },
            },
            {
              key : 'webdriver',
            ...
            },
            {
              key : 'colorDepth',
              getData : function(
                  e, t) { e(window.screen.colorDepth || t.NOT_AVAILABLE); },
            },
            {
              key : 'deviceMemory',
              getData : function(
                  e, t) { e(navigator.deviceMemory || t.NOT_AVAILABLE); },
            },
            {
              key : 'pixelRatio',
              getData : function(
                  e, t) { e(window.devicePixelRatio || t.NOT_AVAILABLE); },
            },
            {
              key : 'hardwareConcurrency',
              getData : function(e, t) { e(x(t)); },
            },
            {
            ...
            },
            {
              ...
              getData : function(e, t) { e(r(t)); },
            },
            {
              key : 'timezoneOffset',
              getData : function(e) { e(new Date().getTimezoneOffset()); },
            },
            {
              key : 'timezone',
              getData : function(e, t) {
                window.Intl && window.Intl.DateTimeFormat
                    ? e(new window.Intl.DateTimeFormat()
                            .resolvedOptions()
                            .timeZone)
                    : e(t.NOT_AVAILABLE);
              },
            ...
            {
              key : 'sessionStorage',
              getData : function(e, t) { e(s(t)); },
            },
            {
              key : 'localStorage',
              getData : function(e, t) { e(A(t)); },
            },
            {
              key : 'indexedDb',
              getData : function(e, t) { e(v(t)); },
            },
            {
              key : 'addBehavior',
              getData : function(
            ...
            {
              key : 'openDatabase',
              getData : function(e) { e(!!window.openDatabase); },
            },
            {
              key : 'cpuClass',
              getData : function(e, t) { e(w(t)); },
            },
            {
              key : 'platform',
              getData : function(e, t) { e(E(t)); },
            },
            {
              key : 'plugins',
              getData : function(e, t) {
            ...
            {
              key : 'canvas',
              getData : function(e, t) { R() ? e(O(t)) : e(t.NOT_AVAILABLE); },
            },
            {
              key : 'webgl',
              getData : function(e, t) { D() ? e(y()) : e(t.NOT_AVAILABLE); },
            },
            {
              key : 'webglVendorAndRenderer',
              getData : function(e) { D() ? e(S()) : e(); },
            },
            {
              key : 'adBlock',
              getData : function(e) { e(C()); },
            },
            {
              key : 'hasLiedLanguages',
              getData : function(e) { e(T()); },
            },
            {
              key : 'hasLiedResolution',
              getData : function(e) { e(b()); },
            },
            {
              key : 'hasLiedOs',
              getData : function(e) { e(_()); },
            },
            {
              key : 'hasLiedBrowser',
              getData : function(e) { e(P()); },
            },
            {
              key : 'touchSupport',
              getData : function(e) { e(t()); },
              ...
              getData : function(e, t) {
                var d = [ 'monospace', 'sans-serif', 'serif' ],
                    l = (l =
                            ...
                            .filter(function(e,
                                             t) { return l.indexOf(e) === t; }),
                    n = document.getElementsByTagName('body')[0],
                    a = document.createElement('div'),
                    f = document.createElement('div'), r = {}, i = {},
                    g = function() {
                      ...
                      return t;
                         ...
                         for (var e = [], t = 0, n = d.length; t < n; t++) {
                           let r = g();
                           (r.style.fontFamily = d[t]), a.appendChild(r),
                               e.push(r);
                         }
                         return e;
                       })();
            ...
            },
            {
              ...
              getData : function(r, e) {
                ...
                if (t.excludeIOS11 &&
                  ...
                  return r(e.EXCLUDED);
                let n = window.OfflineAudioContext ||
                        window.webkitOfflineAudioContext;
                if (null == n)
                  return r(e.NOT_AVAILABLE);
                let a = new n(1, 44100, 44100), i = a.createOscillator();
                (i.type = 'triangle'),
                ...
                d(
                    ...
                    i.connect(o), o.connect(a.destination), i.start(0),
                    a.startRendering();
      ...
      e = {
        get : function(r) {
          var a = {
            data : [],
            addPreprocessedComponent : function(
                e, t) { a.data.push({key : e, value : t}); },
          },
              i = -1, o = function(e) {
                if (k.length <= (i += 1))
                  r(a.data);
                  ...
                  if (c.excludes[t.key])
                    ...
                    if (!e && t.pauseBefore)
                      return (--i, void setTimeout(function() { o(!0); }, 1));
                    try {
        ...
        x64hash128 : function(e, t) {
          t = t || 0;
          for (var n = (e = e || '').length % 16, r = e.length - n,
                   a = [ 0, t ], i = [ 0, t ], o = [ 0, 0 ], c = [ 0, 0 ],
                   u = [ 2277735313, 289559509 ], s = [ 1291169091, 658871167 ],
                   d = 0;
               d < r; d += 16)
            (o =
                 [
                ...
                (o = f(o, u)), (o = g(o, 31)), (o = f(o, s)), (a = m(a, o)),
                (a = g(a, 27)), (a = l(a, i)),
                (a = l(f(a, [ 0, 5 ]), [ 0, 1390208809 ])), (c = f(c, s)),
                (c = g(c, 33)), (c = f(c, u)), (i = m(i, c)), (i = g(i, 31)),
                (i = l(i, a)), (i = l(f(i, [ 0, 5 ]), [ 0, 944331445 ]));
          ...
          case 9:
            (c = m(c, [ 0, e.charCodeAt(d + 8) ])), (c = f(c, s)),
                (c = g(c, 33)), (c = f(c, u)), (i = m(i, c));
          case 8:
          ...
          case 1:
            (o = m(o, [ 0, e.charCodeAt(d) ])), (o = f(o, u)), (o = g(o, 31)),
                (o = f(o, s)), (a = m(a, o));
          }
          return ((a = m(a, [ 0, e.length ])), (i = m(i, [ 0, e.length ])),
                  (a = l(a, i)), (i = l(i, a)), (a = p(a)), (i = p(i)),
                  (a = l(a, i)), (i = l(i, a)),
...
lichess.load.then(
    () => setTimeout(() => {
      const t = performance.now(), storage = lichess.storage.make('fipr'),
            send = hash => {
              storage.set(hash);
