let username = 'jamesflynn';
let userId = username.toLowerCase();
let user = db.user4.findOne({
  _id : userId,
});
if (!user)
  throw 'No such user';
...
print('\n\n Delete user ' + user.username + ' with ' + user.count.game +
      ' games!\n\n');
sleep(5000);
